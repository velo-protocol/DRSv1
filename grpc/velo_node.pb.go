...
type VeloTxReply struct {
	ResultVeloXdr        string   `protobuf:"bytes,1,opt,name=resultVeloXdr,proto3" json:"resultVeloXdr,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *VeloTxReply) GetResultVeloXdr() string {
	if m != nil {
		return m.ResultVeloXdr
	}
	return ""
}
...
var fileDescriptor_a824ed0044bf442b = []byte{
	...
	0x14, 0x49, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0xa1, 0x0b, 0x2b, 0x19, 0x73, 0x71, 0xc3, 0xb4,
	0x16, 0xe4, 0x54, 0x0a, 0xa9, 0x70, 0xf1, 0x16, 0xa5, 0x16, 0x97, 0xe6, 0x94, 0x80, 0x04, 0x11,
	0xda, 0x50, 0x05, 0x8d, 0x7c, 0xb9, 0x38, 0x40, 0x4c, 0xbf, 0xfc, 0x94, 0x54, 0x21, 0x47, 0x2e,
	0xd1, 0xe0, 0xd2, 0xa4, 0xdc, 0x4c, 0xb0, 0x64, 0x48, 0x51, 0x62, 0x5e, 0x71, 0x62, 0x72, 0x49,
	0x66, 0x7e, 0x9e, 0x90, 0xb0, 0x1e, 0xc8, 0x6d, 0x7a, 0x28, 0x0e, 0x93, 0x12, 0x44, 0x15, 0x2c,
	0xc8, 0xa9, 0x54, 0x62, 0x48, 0x62, 0x03, 0xfb, 0xc5, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xab,
	0xd5, 0xc5, 0xdd, 0xde, 0x00, 0x00, 0x00,
}
...
type VeloNodeClient interface {
	SubmitVeloTransaction(ctx context.Context, in *VeloTxRequest, opts ...grpc.CallOption) (*VeloTxReply, error)
}
...
func (c *veloNodeClient) SubmitVeloTransaction(ctx context.Context, in *VeloTxRequest, opts ...grpc.CallOption) (*VeloTxReply, error) {
	out := new(VeloTxReply)
	err := c.cc.Invoke(ctx, "/grpc.VeloNode/SubmitVeloTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VeloNodeServer interface {
	SubmitVeloTransaction(context.Context, *VeloTxRequest) (*VeloTxReply, error)
}
...
func (*UnimplementedVeloNodeServer) SubmitVeloTransaction(ctx context.Context, req *VeloTxRequest) (*VeloTxReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitVeloTransaction not implemented")
}
...
func _VeloNode_SubmitVeloTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VeloTxRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VeloNodeServer).SubmitVeloTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.VeloNode/SubmitVeloTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VeloNodeServer).SubmitVeloTransaction(ctx, req.(*VeloTxRequest))
	}
...
var _VeloNode_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SubmitVeloTransaction",
			Handler:    _VeloNode_SubmitVeloTransaction_Handler,
		},
	},
